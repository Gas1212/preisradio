        ...
        headers: [
          {
            ...
            value: [
              ...
              "connect-src 'self' https://www.clarity.ms https://a.clarity.ms https://*.clarity.ms https://vitals.vercel-insights.com https://api.preisradio.de https://*.google.com https://*.googlesyndication.com https://*.doubleclick.net https://*.google",
